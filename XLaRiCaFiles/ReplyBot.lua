...
if not DevRio:get(XLaRiCa..'Rio:Lock:Reply'..msg.chat_id_) then
...
XLaRiCaTEAM =  "آخلُِآقٌڪڪ لُِڪڪ 𖠙 😒🔪"
Dev_Rio(msg.chat_id_, msg.id_, 1, XLaRiCaTEAM, 1, 'md') 
return false
end
if text == 'السلام عليكم' or text == 'سلام عليكم' then 
XLaRiCaTEAM =  "ياھَہّلْاا ۅﻋ̝̚لْيڪْم الْﺳ̭͠ لْام 𖠙 🤤♥️"
Dev_Rio(msg.chat_id_, msg.id_, 1, XLaRiCaTEAM, 1, 'md') 
return false
end
if text == '😭💔' or text == '😭😭' or text == '😭😭😭' or text == '😿💔' or text == '😭😭😭' or text == '😭😭😭😭' then 
XLaRiCaTEAM =  "مآآعٍآشُ آلُِي يزعٍلُِڪڪ 𖠙 😏♥️"
Dev_Rio(msg.chat_id_, msg.id_, 1, XLaRiCaTEAM, 1, 'md') 
return false
end
if text == '🌚💔' or text == '💔🌚' or text == '🚶‍♂💔' or text == '💔' or text == '😔💔' or text == '🚶‍♀💔' or text == '😭' then 
XLaRiCaTEAM =  "شبّيي اﻟ̣̣פﻟ̣̣و 𖠙 😿💔"
Dev_Rio(msg.chat_id_, msg.id_, 1, XLaRiCaTEAM, 1, 'md') 
return false
end
if text == 'باي' or text == 'بااي' or text == 'اروح' or text == 'اروح احسن' or text == 'اولي احسن' or text == 'راح اروح' or text == 'باي انام' then 
XLaRiCaTEAM =  "أُرٌجُعُ عٍيدِهآآ مٍوو تنِْسةه 𖠙 🤤♥️"
Dev_Rio(msg.chat_id_, msg.id_, 1, XLaRiCaTEAM, 1, 'md') 
return false
end
if text == 'هلو' or text == 'هلاو' or text == 'هلا' or text == 'هلاوو' or text == 'هيلاو' or text == 'هيلاوو' or text == 'هلاا' then 
local XLaRiCaTEAM = {"اࠗط็لق֯ق֯ هٞللاࠗ୨و 𖠙 🤤♥️" ,"هۂَلاا نۨہٰورتت يعمۘري 𖠙 🤤♥️" } 
DevRio2 = math.random(#XLaRiCaTEAM) 
Dev_Rio(msg.chat_id_, msg.id_, 1, XLaRiCaTEAM[DevRio2] , 1, 'md') 
return false
end
...
local XLaRiCaTEAM = {"ماﺷ͠ يةھَہّ يﻋ̝̚مريي ۅاﻧﺗ̲ت 𖠙 🤤♥️" ,"الحۡمۘدللهۂَ ٰوانۨہتت 𖠙 🤤♥️","تمۘامۘ عمۘري ٰوانۨہتت 𖠙 🤤♥️"} 
DevRio2 = math.random(#XLaRiCaTEAM) 
Dev_Rio(msg.chat_id_, msg.id_, 1, XLaRiCaTEAM[DevRio2] , 1, 'md') 
return false
end
if text == 'وينك' or text == 'وينج' then
XLaRiCaTEAM =  "مْوٌجہوٌدِ يہمْگُ يحلوُ 𖠙 😉♥️"
Dev_Rio(msg.chat_id_, msg.id_, 1, XLaRiCaTEAM, 1, 'md') 
return false
end
if text == 'بوت عواي' or text == 'بوت زربه' or text == 'البوت عاوي' or text == 'البوت زربه' then
XLaRiCaTEAM =  "اطردكك تجرب ؟ ، 😕🔪"
Dev_Rio(msg.chat_id_, msg.id_, 1, XLaRiCaTEAM, 1, 'md') 
return false
end
if text == 'نايمين' or text == 'ميتين' then
XLaRiCaTEAM =  "طُآمسين ووعٍيوونڪ 𖠙 😪🖤ۦ"
Dev_Rio(msg.chat_id_, msg.id_, 1, XLaRiCaTEAM, 1, 'md') 
return false
end
if text == 'هلوباي' or text == 'هلو باي' then  
XLaRiCaTEAM =  "شحۡسۜيت مۘنۨہ هيجۚ ּكتبت ؟ 🌝♥️"
Dev_Rio(msg.chat_id_, msg.id_, 1, XLaRiCaTEAM, 1, 'md') 
return false
end
if text == 'اكلك' or text == 'اكلج' or text == 'اكلكم' then 
XLaRiCaTEAM =  "ڪوولُِ مآڪوولُِ لُِآحٍدِ 𖠙 😉♥️"
Dev_Rio(msg.chat_id_, msg.id_, 1, XLaRiCaTEAM, 1, 'md')
return false
end
if text == 'فرخ' or text == 'فرخه' then
XLaRiCaTEAM =  "ٰوينۨہهۂَ خۡل احۡصرهۂَ 𖠙 😹♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1, XLaRiCaTEAM, 1, 'md') 
return false
end
if text == 'سورس ملاذ' or text == 'سورس لاريكا' or text == 'سورس لاريكا' or text == 'سورس زربه' or text == 'السورس زربه' or text == 'سورس عاوي' or text == 'السورس عاوي' then 
XLaRiCaTEAM =  "لُِآ سوورس خآلُِتڪ دِي لُِڪ 𖠙 😒🔪" 
Dev_Rio(msg.chat_id_, msg.id_, 1, XLaRiCaTEAM, 1, 'md')
return false
end
end
...
DevRio:del(XLaRiCa..'Rio:Lock:Reply'..msg.chat_id_)
end end
if text == 'تعطيل ردود البوت' or text == 'تعطيل الردود' then
if DevRio:get(XLaRiCa..'Rio:Lock:Reply'..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '⌁︙ردود البوت بالتاكيد معطله ', 1, 'md')
else
DevRio:set(XLaRiCa..'Rio:Lock:Reply'..msg.chat_id_,true)
