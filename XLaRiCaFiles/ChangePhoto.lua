...
if result.id_ then 
local Rio = DevRio:get("XLaRiCaTeam:Photo"..result.id_)
if not result.profile_photo_ then 
if Rio then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "حذف كل صوره مضروب بوري، 😹💔", 1, 'html')
DevRio:del("XLaRiCaTeam:Photo"..result.id_) 
end
end
...
DevRio:set("XLaRiCaTeam:Photo"..result.id_, result.profile_photo_.big_.persistent_id_) 
end
end
end,nil) 
end
