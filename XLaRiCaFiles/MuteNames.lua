...
if DevRio:get(XLaRiCa.."Rio:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevRio:sadd(XLaRiCa.."Rio:Mute:Names"..msg.chat_id_, MuteName)
end
...
if not Manager(msg) and DevRio:get(XLaRiCa.."Rio:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
XLaRiCaName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if XLaRiCaName then 
XLaRiCaNames = DevRio:smembers(XLaRiCa.."Rio:Mute:Names"..msg.chat_id_) or ""
if XLaRiCaNames and XLaRiCaNames[1] then 
for i=1,#XLaRiCaNames do 
if XLaRiCaName:match("(.*)("..XLaRiCaNames[i]..")(.*)") then 
...
DevRio:set(XLaRiCa.."Rio:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevRio:del(XLaRiCa.."Rio:Lock:MuteNames"..msg.chat_id_)
end
end
end
